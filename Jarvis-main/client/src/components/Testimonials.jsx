...
const Testimonials = () => {
    const details = [
        ...
        },
        {
            ...
            writer: 'Mike , High School Senior',
        },
        {
        ...
        },
        {
            ...
            writer: 'Rahul, College Sophomore'
        }
    ];
